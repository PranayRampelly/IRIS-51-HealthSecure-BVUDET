...
export const VoiceMessagePlayer: React.FC<VoiceMessagePlayerProps> = ({
    ...
    useEffect(() => {
        ...
        // Force reload and reset when URL changes
        audio.pause();
        audio.load();
        setIsPlaying(false);
        setCurrentTime(0);
    ...
    return (
        <div className={`p-3 rounded-lg flex flex-col gap-2 max-w-[280px] ${isOwnMessage ? 'bg-health-aqua/20' : 'bg-health-blue-gray/10'}`}>
